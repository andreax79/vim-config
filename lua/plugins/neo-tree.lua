...
return {
  ...
  lazy = false,
  keys = {
    { '<leader>t', ':Neotree filesystem toggle left<CR>', desc = 'NeoTree filesystem', silent = true },
    { '<leader>g', ':Neotree git_status toggle float<CR>', desc = 'NeoTree git status', silent = true },
    { "-", "<Cmd>Neotree toggle reveal filesystem current<CR>", { noremap = true, silent = true }},
  },
  opts = {
